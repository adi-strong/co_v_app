...
import FactureConsultItem from "./FactureConsultItem.tsx";

export default function FactureConsultData({ factures }: { factures: FactureConsultation[] }) {
    ...
    <>
      ...
      <Table hover striped responsive>
        ...
        {factures.length > 0 && factures.map((c, index: number) =>
          <FactureConsultItem key={index} facture={c}/>)}
        </tbody>
      </Table>
    </>
  )
