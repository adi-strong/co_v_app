...
export interface CategorieErrorExam { nom: string | null }
...
export const initCategorieExamErrorState = (): CategorieErrorExam => ({ nom: null })
// END INIT
...
export async function onPatchCategorieExamSubmit(
  ...
  setErrors: Dispatch<SetStateAction<CategorieErrorExam>>,
