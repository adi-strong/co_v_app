...
import {getApproHeadItems} from "../model/approService.ts";
import ApproItem from "./ApproItem.tsx";
import {Link} from "react-router-dom";

export default function ApproData({ appros }: { appros: Appro[] }) {
  ...
  return (
    <>
      ...
      <Table hover responsive>
        ...
        <tr>
          {getApproHeadItems().length > 0 && getApproHeadItems().map(t =>
