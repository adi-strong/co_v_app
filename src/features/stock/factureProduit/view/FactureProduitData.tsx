...
import FactureProduitItem from "./FactureProduitItem.tsx";
...
export default function FactureProduitData(props: {
  ...
  const { factures, setFactures } = props
  ...
  return (
    <>
      ...
      <Table hover striped responsive>
        ...
        <tr>
          <th style={{fontSize: '1rem'}}>Client<span className='text-lowercase'>(e)</span></th>
